...
A tela continua na matrícula e mostra **"Matrícula 9999999 não encontrada."**,
com os números que você digitou.

Quase sempre é dígito trocado ou zero da frente esquecido: `0012345` e `12345`
...
Você entra normalmente, o seu nome aparece no alto, e no lugar da grade de
categorias surge **"Este cadastro está inativo e não pode retirar
equipamento."**

A trava é de um lado só, e isso é de propósito: ela bloqueia a **retirada** e
libera a **devolução**. Quem é inativado — trancou a matrícula, se formou, saiu
da instituição — quase sempre está com um aparelho na mochila. Se o portal
travasse os dois lados, a inativação viraria a garantia de que aquele
...
**Na sua tela, ele não consta.** Assim que você confirma, o item sai de
