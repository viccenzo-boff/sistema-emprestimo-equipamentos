...
| Painel | Uma linha no pé da barra lateral, abaixo do bloco da conta: `Desenvolvido por [Viccenzo Boff](github)` — **com link**, em nova aba | O público é a secretaria e a coordenação, em desktop com mouse: link não é porta de saída, e é onde a coordenação vai de fato ver o crédito |
