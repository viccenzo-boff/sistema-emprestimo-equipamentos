...
| Pior nota | Rosto **triste**, nunca bravo | Escala de um eixo só (valência). Raiva é outra dimensão (ativação + culpa), ninguém aperta "bravo" num tablet compartilhado com o secretário a dois metros, e a ponta baixa esvazia |
